...
Fork the project [on GitHub](https://github.com/geut/fastify-uws) and check out your copy locally.

```bash
$ git clone git@github.com:username/fastify-uws.git
$ cd fastify-uws
$ npm install
$ git remote add upstream git://github.com/geut/fastify-uws.git
```
